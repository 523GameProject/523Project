...
var iEnemySpeed = 10; // initial enemy speed
...
function Enem(x, y, w, h, speed, image) {
    this.x = x;
    this.y = y;
    this.w = w;
    this.h = h;
            ...
            if (enemies[ekey] != undefined) {
                ...
                if (enemies[ekey].x < - iEnemyW) {
					...
					if(inFire)
					{
		                ...
		                document.getElementById("enemys").style.display = "block";
		                document.getElementById("fire").style.display = "none";
		                document.getElementById("debug_canvas").width = "1200";
		                document.getElementById("debug_canvas").height = "600";
						ws.send("pt" + ":" + player_mgr.players[0].names + ":"+ iScore);
						iBgShiftX = 100;
                        dragon = new Dragon(400, 300, dragonW, dragonH, oDragonImage);
                        balls = [];
                        enemies = [];
                        iSprPos = 0; // initial sprite frame
                        iSprDir = 0; // initial dragon direction

                        bMouseDown = false; // mouse down state
                        iLastMouseX = 0;
                        iLastMouseY = 0;
                        iScore = 0;
					}
...
$(function(){
    ...
    function addEnemy() {
        ...
        enemies.push(new Enem(canvas.width, randY, iEnemyW, iEnemyH, - iEnemySpeed, oEnemyImage));
